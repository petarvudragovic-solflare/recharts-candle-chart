...
// node_modules/@storybook/react/dist/chunk-MNKU3DTE.mjs
...
var Wrapper = FRAMEWORK_OPTIONS?.strictMode ? import_react.StrictMode : import_react.Fragment;
var actQueue = [];
var isActing = false;
...
async function renderToCanvas({ storyContext, unboundStoryFn, showMain, showException, forceRemount }, canvasElement) {
  let { renderElement, unmountElement } = await import("./react-18-TISCIYBI.js"), Story = unboundStoryFn, content = storyContext.parameters.__isPortableStory ? import_react.default.createElement(Story, { ...storyContext }) : import_react.default.createElement(ErrorBoundary, { key: storyContext.id, showMain, showException }, import_react.default.createElement(Story, { ...storyContext })), element = Wrapper ? import_react.default.createElement(Wrapper, null, content) : content;
...
//# sourceMappingURL=chunk-RH2QDOKK.js.map
